...
# SCATTER PLOT - AGE
  flust_test %>%
   ...
   stat_cor(method = "pearson", aes(label = ..r.label..),  label.x = 0, label.y = c(5, 10), show.legend = FALSE, size=3)+
    scale_shape_manual(values = c(1, 21)) +
    scale_colour_manual(values = c("gray20", "grey60")) +
