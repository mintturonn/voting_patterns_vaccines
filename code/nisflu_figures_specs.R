...
min_theme <-  theme(#axis.text.x = element_blank(),
                    ...
                    axis.text.x = element_text(hjust=1, vjust=0, size = 5, color = "black", face = "plain", angle = 0),
                    axis.text.y = element_text(hjust=1, vjust=0.5, size = 5, color = "black", face = "plain"),
                    axis.ticks = element_blank(),
                    axis.title.x = element_blank(),
                    axis.title.y = element_text(hjust = 0, size = 6, face = "bold"),
                    panel.background =  element_blank(),
                    panel.border = element_rect(colour="black", fill=NA, linewidth=0.01), # element_blank(),
...
min_theme2 <-  theme( #axis.text.x = element_blank(),
                      ...
                      axis.text.y = element_text(hjust=1, vjust=0, size = 10, color = "black", face = "plain"),
                      axis.ticks = element_blank(),
...
min_theme_fig4 <-  theme(
                    axis.text.x = element_text(hjust=1, vjust=0, size = 11, color = "black", face = "plain", angle = 0),
                    axis.text.y = element_text(hjust=1, vjust=0.5, size = 12, color = "black", face = "plain"),
                    axis.ticks = element_blank(),
